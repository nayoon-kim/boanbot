...
class Hub:
    ...
    category_in_dailysecu = {"의료 보안": "?sc_serial_code=SRN5&view_type=sm", "해외 보안 뉴스(한글)":"?sc_serial_code=SRN4&view_type=sm", "주의 이슈": "?sc_serial_code=SRN2&view_type=sm", "query": ""}
